...
This app keeps track of your assets (stocks, crypto, etc's) and gets real time price data from Alphavantage.
...
- check/fix put/post/delete methods for user and assets
